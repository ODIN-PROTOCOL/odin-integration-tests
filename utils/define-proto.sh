...
protoc \
  ...
  "$ODIN_PROTO_DIR/oracle/v1/query.proto" \
  "$ODIN_PROTO_DIR/mint/tx.proto" \
  "$ODIN_PROTO_DIR/mint/mint.proto" \
  "$ODIN_PROTO_DIR/mint/query.proto" \
  "$ODIN_PROTO_DIR/coinswap/tx.proto" \
  "$ODIN_PROTO_DIR/coinswap/query.proto" \
  "$ODIN_PROTO_DIR/auction/tx.proto" \
  "$ODIN_PROTO_DIR/auction/query.proto" \
  "$ODIN_PROTO_DIR/telemetry/telemetry.proto" \
  "$ODIN_PROTO_DIR/telemetry/query.proto" \
