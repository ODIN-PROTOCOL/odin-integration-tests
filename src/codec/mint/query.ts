...
export const QueryTreasuryPoolRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryTreasuryPoolRequest>
  ): QueryTreasuryPoolRequest {
    const message = {
      ...baseQueryTreasuryPoolRequest,
    } as QueryTreasuryPoolRequest;
...
export const QueryTreasuryPoolResponse = {
  ...
  toJSON(message: QueryTreasuryPoolResponse): unknown {
    ...
    if (message.treasuryPool) {
      obj.treasuryPool = message.treasuryPool.map((e) =>
  ...
  fromPartial(
    object: DeepPartial<QueryTreasuryPoolResponse>
  ): QueryTreasuryPoolResponse {
    const message = {
      ...baseQueryTreasuryPoolResponse,
    } as QueryTreasuryPoolResponse;
...
export interface Query {
  ...
  ): Promise<QueryTreasuryPoolResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  TreasuryPool(
    ...
    return promise.then((data) =>
      QueryTreasuryPoolResponse.decode(new _m0.Reader(data))
    );
  }
}
