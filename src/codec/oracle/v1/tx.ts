...
export const MsgCreateDataSourceResponse = {
    ...
    fromPartial(
        _: DeepPartial<MsgCreateDataSourceResponse>
    ): MsgCreateDataSourceResponse {
        const message = {
            ...baseMsgCreateDataSourceResponse,
        } as MsgCreateDataSourceResponse;
...
export const MsgEditDataSourceResponse = {
    ...
    fromPartial(
        _: DeepPartial<MsgEditDataSourceResponse>
    ): MsgEditDataSourceResponse {
        const message = {
            ...baseMsgEditDataSourceResponse,
        } as MsgEditDataSourceResponse;
...
export const MsgCreateOracleScript = {
    ...
    fromPartial(
        object: DeepPartial<MsgCreateOracleScript>
    ): MsgCreateOracleScript {
        const message = {...baseMsgCreateOracleScript} as MsgCreateOracleScript;
        if (object.name !== undefined && object.name !== null) {
            message.name = object.name;
...
export const MsgCreateOracleScriptResponse = {
    encode(
        _: MsgCreateOracleScriptResponse,
        writer: _m0.Writer = _m0.Writer.create()
    ): _m0.Writer {
        return writer;
    },
    ...
    fromPartial(
        _: DeepPartial<MsgCreateOracleScriptResponse>
    ): MsgCreateOracleScriptResponse {
        const message = {
            ...baseMsgCreateOracleScriptResponse,
        } as MsgCreateOracleScriptResponse;
...
export const MsgEditOracleScriptResponse = {
    ...
    fromPartial(
        _: DeepPartial<MsgEditOracleScriptResponse>
    ): MsgEditOracleScriptResponse {
        const message = {
            ...baseMsgEditOracleScriptResponse,
        } as MsgEditOracleScriptResponse;
...
export const MsgRemoveReporterResponse = {
    ...
    fromPartial(
        _: DeepPartial<MsgRemoveReporterResponse>
    ): MsgRemoveReporterResponse {
        const message = {
            ...baseMsgRemoveReporterResponse,
        } as MsgRemoveReporterResponse;
...
export interface Msg {
    ...
    CreateDataSource(
        request: MsgCreateDataSource
    ): Promise<MsgCreateDataSourceResponse>;

    /** EditDataSource defines a method for editing an existing data source. */
    EditDataSource(
        request: MsgEditDataSource
    ): Promise<MsgEditDataSourceResponse>;

    /** CreateOracleScript defines a method for creating a new oracle script. */
    CreateOracleScript(
        request: MsgCreateOracleScript
    ): Promise<MsgCreateOracleScriptResponse>;

    /** EditOracleScript defines a method for editing an existing oracle script. */
    EditOracleScript(
        request: MsgEditOracleScript
    ): Promise<MsgEditOracleScriptResponse>;
    ...
    RemoveReporter(
        request: MsgRemoveReporter
    ): Promise<MsgRemoveReporterResponse>;
}
...
export class MsgClientImpl implements Msg {
    ...
    RequestData(request: MsgRequestData): Promise<MsgRequestDataResponse> {
        ...
        return promise.then((data) =>
            MsgRequestDataResponse.decode(new _m0.Reader(data))
        );
    }
    ...
    ReportData(request: MsgReportData): Promise<MsgReportDataResponse> {
        ...
        return promise.then((data) =>
            MsgReportDataResponse.decode(new _m0.Reader(data))
        );
    }
    ...
    CreateDataSource(
        ...
        return promise.then((data) =>
            MsgCreateDataSourceResponse.decode(new _m0.Reader(data))
        );
    }
    ...
    EditDataSource(
        ...
        return promise.then((data) =>
            MsgEditDataSourceResponse.decode(new _m0.Reader(data))
        );
    }
    ...
    CreateOracleScript(
        ...
        return promise.then((data) =>
            MsgCreateOracleScriptResponse.decode(new _m0.Reader(data))
        );
    }
    ...
    EditOracleScript(
        ...
        return promise.then((data) =>
            MsgEditOracleScriptResponse.decode(new _m0.Reader(data))
        );
    }
    ...
    AddReporter(request: MsgAddReporter): Promise<MsgAddReporterResponse> {
        ...
        return promise.then((data) =>
            MsgAddReporterResponse.decode(new _m0.Reader(data))
        );
    }
    ...
    RemoveReporter(
        ...
        return promise.then((data) =>
            MsgRemoveReporterResponse.decode(new _m0.Reader(data))
        );
    }
}
