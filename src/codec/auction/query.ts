...
export const QueryAuctionStatusRequest = {
  ...
  fromPartial(
    _: DeepPartial<QueryAuctionStatusRequest>
  ): QueryAuctionStatusRequest {
    const message = {
      ...baseQueryAuctionStatusRequest,
    } as QueryAuctionStatusRequest;
...
export const QueryAuctionStatusResponse = {
  ...
  fromPartial(
    object: DeepPartial<QueryAuctionStatusResponse>
  ): QueryAuctionStatusResponse {
    const message = {
      ...baseQueryAuctionStatusResponse,
    } as QueryAuctionStatusResponse;
...
export interface Query {
  ...
  AuctionStatus(
    request: QueryAuctionStatusRequest
  ): Promise<QueryAuctionStatusResponse>;
}
...
export class QueryClientImpl implements Query {
  ...
  AuctionStatus(
    ...
    return promise.then((data) =>
      QueryAuctionStatusResponse.decode(new _m0.Reader(data))
    );
  }
}
